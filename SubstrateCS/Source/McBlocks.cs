   ...
   public static class McBlocks
    {
        ...
        static McBlocks()
        {
            ...
            Torch = new BlockInfo(50, "Torch").SetOpacity(0).SetLuminance(BlockInfo.MAX_LUMINANCE - 1).SetState(BlockState.NONSOLID).SetTick(10);
            Fire = new BlockInfo(51, "Fire").SetOpacity(0).SetLuminance(BlockInfo.MAX_LUMINANCE).SetState(BlockState.NONSOLID).SetTick(40);
            ...
            EndPortal = (BlockInfoEx)new BlockInfoEx(119, "End Portal").SetOpacity(0).SetLuminance(BlockInfo.MAX_LUMINANCE).SetState(BlockState.NONSOLID);
